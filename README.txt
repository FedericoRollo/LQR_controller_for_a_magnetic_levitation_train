...
Control design for a transrapid (magnetic levitation train type) is here proposed using LQR. Simulation of the controlled system are presented using Simulink. 
